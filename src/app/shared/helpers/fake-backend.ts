        ...
        setTimeout(() => {
            ...
            if (connection.request.url.endsWith('/api/authenticate') && connection.request.method === RequestMethod.Post) {
                ...
                const filteredUsers = users.filter(user => {
                    return user.mobile_number === (params.mobile_number).toString() && user.password === params.password;
                });
            ...
            if (connection.request.url.endsWith('/api/users') && connection.request.method === RequestMethod.Post) {
                ...
                // validation
                const duplicateUser = users.filter(user => user.mobile_number === newUser.mobile_number ).length;
                if (duplicateUser) {
                    return connection.mockError(new Error('Username "' + newUser.mobile_number + '" is already taken'));
                }
